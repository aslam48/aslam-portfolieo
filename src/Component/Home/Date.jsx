...
const Date = () => {
  return (
        ...
        <div className="home__data">
            <h1 className="home__title">Aslam Iliyas 
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
                ...
                <h3 className="home__subtitle">Front-End | BlockChain Developer </h3>
                <p className='home__description'>I,m a Front-end developer with a special focus on understanding user stories and ensuring users have a stress-free experience when navigating through any application. </p>
